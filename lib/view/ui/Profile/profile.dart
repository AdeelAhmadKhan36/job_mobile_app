        ...
        bottomNavigationBar: Padding(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                child: isLoading
                    ? CircularProgressIndicator(color: Colors.white,) // Show circular progress indicator if isLoading is true
                    : Text(
                  "Submit Application",
                  style: TextStyle(
                    color: Colors.white,
    ...
    FirebaseFirestore.instance
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        FirebaseFirestore.instance
          ...
          Utils().toastMessage('Fails to submit application! Please try again');

          setState(() {
            isLoading = false; // Set isLoading to false if there's an error during submission
          });
        });
      }
    }).catchError((error) {
